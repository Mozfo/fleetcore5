/**
 * NurturingJ7 Email Template
 *
 * V6.6 - J+7 nurturing email (sent 7 days after J+1)
 *
 * Final reminder, no artificial urgency.
 * Sent when: nurturing_step=1, last_nurturing_at >= 6 days ago
 *
 * @module emails/templates/NurturingJ7
 */
      ...
      <Body style={main(isRtl)}>
        <Container style={container} className="container">
          <Section style={box} className="content-wrapper">
            ...
            {/* CTA Text */}
            <Text style={smallText(textAlign)}>{t.ctaText}</Text>
            ...
            {/* Stay in touch */}
            <Text style={smallText(textAlign)}>{t.stayInTouch}</Text>
