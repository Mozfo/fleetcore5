...
export const WebhookTest = ({
  ...
  const t = webhookTestTranslations[locale];
      ...
      <Body style={main(isRtl)}>
        <Container style={container} className="container">
          <Section style={box} className="content-wrapper">
            ...
            <Hr style={hr} />
            <Text style={paragraph(textAlign)}>{t.testNotification}</Text>
            <Text style={paragraph(textAlign)}>
              • {t.timestamp}: <strong>{timestamp}</strong>
              <br />• {t.testId}: <strong>{test_id}</strong>
            </Text>
            <Text style={paragraph(textAlign)}>{t.configuredCorrectly}</Text>
            <Text style={paragraph(textAlign)}>{t.engineering}</Text>
            <Hr style={hr} />
