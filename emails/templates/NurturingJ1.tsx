/**
 * NurturingJ1 Email Template
 *
 * V6.6 - J+1 nurturing email (sent 24h after migration to nurturing)
 *
 * Value-focused with savings data (142-228/vehicle/month, 6.5x ROI, 35% admin reduction).
 * Sent when: nurturing_step=0, created >= 24h ago
 *
 * @module emails/templates/NurturingJ1
 */
      ...
      <Body style={main(isRtl)}>
        <Container style={container} className="container">
          <Section style={box} className="content-wrapper">
            ...
            {/* CTA Text */}
            <Text style={paragraph(textAlign)}>{t.ctaText}</Text>
