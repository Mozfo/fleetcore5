 ...
 *
 * IMPORTANT - Tab Navigation Best Practice:
 * When using Dialog with forms, always set `modal={false}` on the Dialog Root
 * to enable proper Tab key navigation between form fields.
 *
 * Example:
 * ```tsx
 ...
 * ```
 *
 * Why: Radix Dialog's focus trap (modal={true} by default) interferes with
 * Tab navigation in forms. See: https://github.com/radix-ui/primitives/issues/2989
 *
 * Trade-off: With modal={false}, clicking outside the dialog will close it.
 * This is acceptable UX for form modals.
 */
