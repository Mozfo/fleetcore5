/* eslint-disable react-hooks/preserve-manual-memoization, react-hooks/exhaustive-deps, eqeqeq */
"use client";
            ...
            className={cn(
              "bg-muted flex flex-col gap-2 rounded-lg p-2.5",
              {
                ...
                "data-dragging:cursor-grabbing":
                  !context.flatCursor && !disabled,
                "cursor-grab":
                  !isDragging && asHandle && !context.flatCursor && !disabled,
