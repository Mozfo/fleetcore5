...
/**
 * Sheet Component (Radix UI Dialog-based)
 *
 * A slide-in drawer/panel component based on Dialog primitives.
 * Uses slide animations instead of zoom for drawer-like behavior.
 *
 * Usage:
 * ```tsx
