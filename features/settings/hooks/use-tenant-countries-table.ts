...
export function useTenantCountriesTable({
  ...
  const table = useReactTable({
    ...
    filterFns: {
      fuzzy: fuzzyFilter as FilterFn<SettingsTenantCountry>,
      faceted: facetedFilter as FilterFn<SettingsTenantCountry>,
    },
    globalFilterFn: fuzzyFilter as FilterFn<SettingsTenantCountry>,
