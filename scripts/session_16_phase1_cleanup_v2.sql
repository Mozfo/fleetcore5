...
\echo ''
\prompt 'Backup vérifié et restore testable? (yes/no): ' backup_verified
...
\echo ''
\prompt 'C''est le BON environnement? (yes/no): ' env_confirmed
...
\prompt 'Confirmer suppression 22 colonnes V1? (yes/no): ' confirm_drop
