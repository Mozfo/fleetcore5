...
| ------------------------- | ----------------------------------------------- | ----------------------------------------------------------------------------------------------------- |
| `app.current_tenant_id`   | ~47 tables client (clt*\*, flt*_, fin\__, etc.) | Middleware API Client via `with-tenant-context.ts` (a creer — equivalent de with-provider-context.ts) |
