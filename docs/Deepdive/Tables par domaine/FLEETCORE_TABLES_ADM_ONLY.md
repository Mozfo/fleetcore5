...
**Tables Support Provider (3 tables) - CRITIQUES**
6. `adm_provider_employees` - Staff FleetCore avec permissions cross-tenant
7. `adm_tenant_lifecycle_events` - Historique changements statut tenants
8. `adm_invitations` - Gestion invitations et onboarding sécurisé
