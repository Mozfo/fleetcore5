...
14. `doc_documents` - Stockage documents polymorphe

**Nouvelles Tables V2 (3 tables)**
15. `doc_document_types` - Référentiel types de documents
16. `doc_entity_types` - Référentiel types d'entités supportées
17. `doc_document_versions` - Historique versionnement documents
